"""Pluggable, multi-ecosystem test adapter protocol and implementations."""
...
REGISTRY: list[TestAdapter] = [PytestAdapter(), VitestAdapter()]
...
def get_adapter(root: Path, explicit_adapter: str | None = None) -> TestAdapter:
    ...
    best_adapter: TestAdapter = REGISTRY[0]
    best_score = -1.0
